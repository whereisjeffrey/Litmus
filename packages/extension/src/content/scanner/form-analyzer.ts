  ...
  forms.forEach((form, fi) => {
    ...
    inputs.forEach((input) => {
      ...
      if (field.type === "password" && !field.hasPasswordToggle) {
        findings.push({
          ...
          scanner: "form-analyzer",
          severity: "info",
          title: "Password field without visible toggle",
          description:
      ...
      if (field.type === "password") {
        ...
        if (!hasUsernameField) {
          findings.push({
            ...
            scanner: "form-analyzer",
            severity: "info",
            title: "Password field without visible username/email field",
            description:
    ...
    if ((radioGroups.size > 0 || checkboxGroups.size > 0) && !hasFieldset) {
      ...
      findings.push({
        ...
        scanner: "form-analyzer",
        severity: "warning",
        title: "Related inputs without fieldset/legend",
  ...
  allInputs.forEach((input) => {
    ...
    if (!field.hasLabel && !field.hasAriaLabel) {
      findings.push({
        ...
        scanner: "form-analyzer",
        severity: "critical",
        title: "Orphaned input missing label",
