...
export function checkMeta(): MetaResult {
  ...
  if (!title) {
    ...
    findings.push({
      ...
      scanner: "meta-checker",
      severity: "warning",
      title: `Title is very short (${titleLength} characters)`,
    ...
    findings.push({
      ...
      scanner: "meta-checker",
      severity: "info",
      title: `Title may be truncated in search (${titleLength} characters)`,
      description:
  ...
  if (!description) {
    ...
    findings.push({
      ...
      scanner: "meta-checker",
      severity: "info",
      title: `Meta description is short (${descriptionLength} characters)`,
    ...
    findings.push({
      ...
      scanner: "meta-checker",
      severity: "info",
      title: `Meta description may be truncated (${descriptionLength} characters)`,
      description:
